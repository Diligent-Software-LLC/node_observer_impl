require_relative './lib/node_observer_impl/version'
...
Gem::Specification.new do |spec|
  ...
  spec.description           = %q{A NodeObserver library implementation.
Donations support continuous improvement and maintenance. The aim is a
reliable, integrable, and endurable Observer library. Make a donation at the
project's collective page: https://opencollective.com/observer. One-time and
recurring donations are available at $1, $2, $4, $8, and $16. Greatly
appreciated.}
  spec.homepage              =
      "https://docs.diligentsoftware.org/observer-1/node/implementation"
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/node_observer_impl"
